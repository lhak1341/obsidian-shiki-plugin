...
## Corpus Check
- 25 files · ~13,730 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 194 nodes · 242 edges · 24 communities (17 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3f95bfe9`
...
Cohesion: 0.18
Nodes (6): Cm6_Util, Cm6ViewPluginHost, DecorationUpdate, DecorationUpdateType, InsertDecoration, RemoveDecoration
...
Cohesion: 0.25
Nodes (7): ESLint, Known build warnings, Narrow host interfaces, obsidian-shiki-plugin, Package structure, Settings invariant, Testing
...
## Knowledge Gaps
- **65 isolated node(s):** `CodeBlockHost`, `PrismFilterHighlightEnv`, `PrismFilterHighlightCondition`, `PrismFilterHighlightApi`, `PrismBeforeAllElementsHighlightEnv` (+60 more)
...
- **Why does `CodeHighlighter` connect `Community 2` to `Community 0`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `ThemeMapper` connect `Community 8` to `Community 0`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **What connects `CodeBlockHost`, `PrismFilterHighlightEnv`, `PrismFilterHighlightCondition` to the rest of the system?**
